...
describe('getAdjustedLatitude test cases', () => {
  ...
  it('General use cases', () => {
    ...
    results.forEach((elem, idx) => {
      expect(getAdjustedLatitude(slopes[idx], adjustedLatitudes[idx], unadjustedLatLongs[idx])).toBeCloseTo(
        elem,
        2
      )
    })
...
describe('getAdjustedLongitude test cases', () => {
  ...
  it('General use cases', () => {
    ...
    results.forEach((elem, idx) => {
      expect(getAdjustedLongitude(slopes[idx], adjustedLatitudes[idx], unadjustedLatLongs[idx])).toBeCloseTo(
        elem,
        2
      )
    })
